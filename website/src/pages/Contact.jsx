    ...
    return (
        <div className="subpage">
            <div className="d-flex flex-row align-items-center">
                <img src="Smile.svg" width="150" height="150" alt="Kaylee Chan pixel avatar smiling" />
                <h1>Contact Me</h1>
                <img src="Smile.svg" width="150" height="150" className="h-flip" alt="Kaylee Chan pixel avatar smiling" />
            </div>
            <div className="d-flex flex-column justify-content-center align-items-center mt-3 gap-3">
                <div className="d-flex flex-row text-primary-white gap-2 justify-content-center align-items-center">
                    ...
                    <p className="contact-text">Email: kayleel.chan@gmail.com</p>
                </div>
                <div className="d-flex flex-row text-primary-white gap-2 justify-content-center align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-linkedin align-text-center" viewBox="0 0 16 16">
                    ...
                    <p className="contact-text">Linkedin: https://www.linkedin.com/in/kaylee-chan/</p>
                </div>
            </div>
        </div>
    );
