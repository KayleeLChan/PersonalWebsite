...
const Footer = () => {
    return (
        <footer className="d-flex flex-row justify-content-center align-items-center gap-3 bg-dark-pink">
            <Button variant="outline-primary-white" className="ratio-1x1" href="https://www.linkedin.com/in/kaylee-chan/" target="_blank" rel="noopener noreferrer">
            ...
            <Button variant="outline-primary-white" className="ratio-1x1" href="https://kayleelchan.itch.io/" target="_blank" rel="noopener noreferrer" >
            ...
            <Button variant="outline-primary-white" className="ratio-1x1" href="https://github.com/KayleeLChan" target="_blank" rel="noopener noreferrer">
            ...
            <Button variant="outline-primary-white" className="ratio-1x1" href="resume.pdf" target="_blank" rel="noopener noreferrer">
